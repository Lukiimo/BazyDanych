...
' otrzyma³ pensjê ca³kowit¹ na kwotê ', pensje.kwota + premie.kwota + ( case when (ksiegowosc.godziny.liczba_godzin - 52)*20 > 0 then ((ksiegowosc.godziny.liczba_godzin - 52)*20) else 0 end),' zl, gdzie wynagrodzenie zasadnicze wynosilo: ', pensje.kwota , ' zl, premia: ', 
