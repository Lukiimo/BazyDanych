...
create table geo.geoEra( id_era int primary key, nazwa_era varchar(30),	id_eon int );

create table geo.GeoOkres(id_okres int primary key, nazwa_okres varchar(30), id_era int );

create table geo.GeoEpoka( id_epoka int primary key, nazwa_epoka varchar(30), id_okres int );

create table geo.GeoPietro(id_pietro int primary key, nazwa_pietro varchar(30),	id_epoka int );

select * from geo.GeoOkres;

alter table geo.geoEra add foreign key (id_eon) references GeoEon (id_eon);
